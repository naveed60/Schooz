    ...
    <main className='auth-page'>
      ...
      <div className='auth-content'>
        <div className='auth-form-wrap register-wrap'>
          ...
          {params.error && <p className='form-error' role='alert'>Unable to create your account. Check your details and try again.</p>}
          <form className='auth-form' action={registerAction}>
            ...
            <button className='button form-button' type='submit'>Create account <span aria-hidden='true'>→</span></button>
          </form>
